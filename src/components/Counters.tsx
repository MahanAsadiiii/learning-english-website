import { Add, PercentageSquare } from "iconsax-react"
        ...
        <div className="mt-8 ">
            ...
            <div className='flex justify-between text-white py-28'>
                <div className="flex flex-col items-center">
                    <CountUp start={0} end={500} duration={6} prefix="+" className="text-5xl font-bold"/>
                    <small className="text-3xl text-[var(--gray-2)] mt-2">videos</small>
                </div>
                <div className="flex flex-col items-center">
                    <CountUp start={0} end={15000} duration={6} prefix="+" className="text-5xl font-bold"/>
                    <small className="text-3xl text-[var(--gray-2)] mt-2">User</small>
                </div>
                <div className="flex flex-col items-center">
                    <CountUp start={0} end={95} duration={6} prefix="%" className="text-5xl font-bold"/>
